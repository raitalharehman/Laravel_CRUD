...
<div class="container">
    <div class="row text-center">
        <h2 style="color: #238c59; font-weight: bold;padding: 10px;">Update Product</h2>
    </div>
        ...
        <div class="col-md-12 card" style="background-color: #ffffff;">
            <div class="row">
                <div class="input-field col s12" style="margin-top: 30px;">
                    <input name="product_name" style="font-size: 14px;" value="{{$product->product_name}}"
            ...
            <div class="row">
                <div class="input-field col s12">
                    <input name="price" style="color: #040404; font-size: 14px;" value="{{$product->price}}"
                           id="price" type="number"
                           class="validate">
                    <label for="price" style="color: #238c59;font-size: 14px;">Price</label>
                </div>
            </div>
